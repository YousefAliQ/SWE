...
public class MortgageTest {
	...
	@Test
	public void test1() {
		Employee architect = new Employee(1967, 5, 2, 3000, false, 0, Profession.Architect);
	...
	@Test
	public void test2() {
		Employee architect = new Employee(2001, 5, 2, 3000, false, 0, Profession.Architect);
		MortgageCalculator mc = new MortgageCalculator();
		double result = mc.computeMaxMortgage(architect);
	...
	@Test
	public void test4() {
		Employee professor = new Employee(2001, 5, 2, 3000, false, 0, Profession.Professor);
		MortgageCalculator mc = new MortgageCalculator();
